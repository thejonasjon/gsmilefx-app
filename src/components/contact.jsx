          ...
          >
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-gray-400">123 Trading Street, New York, NY 10001</p>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={handleChange}
                    className="min-h-[150px] bg-gray-800 border-gray-700 text-white focus:border-green-500 focus:ring-green-500"
                    required
                  />
                </div>
                <Button
